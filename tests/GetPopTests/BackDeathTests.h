...
TYPED_TEST_P(BackDeathTest, WhenEmptyGetAsserts) { ASSERT_DEATH((void) this->emptyContainer.back(), ""); }

TYPED_TEST_P(BackDeathTest, WhenEmptyPopAsserts) { ASSERT_DEATH(this->emptyContainer.pop_back(), ""); }

TYPED_TEST_P(BackDeathTest, WhenEmptyPopNAsserts) { ASSERT_DEATH(this->emptyContainer.pop_back(5), ""); }
